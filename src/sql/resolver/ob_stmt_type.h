...
OB_STMT_TYPE_DEF(T_CREATE_UDF_MODEL, no_priv_needed, 306, ACTION_TYPE_CREATE_UDF_MODEL)
OB_STMT_TYPE_DEF(T_DROP_UDF_MODEL, no_priv_needed, 307, ACTION_TYPE_DROP_UDF_MODEL)
OB_STMT_TYPE_DEF(T_ALTER_UDF_MODEL, no_priv_needed, 308, ACTION_TYPE_ALTER_UDF_MODEL)
