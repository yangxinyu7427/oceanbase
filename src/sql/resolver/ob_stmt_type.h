...
OB_STMT_TYPE_DEF(T_CREATE_PYTHON_UDF, no_priv_needed, 284, ACTION_TYPE_CREATE_PYTHON_UDF)
OB_STMT_TYPE_DEF(T_DROP_PYTHON_UDF, no_priv_needed, 285, ACTION_TYPE_DROP_PYTHON_UDF)
