...
#define OB_ERR_INVALID_PYTHON_UDF__USER_ERROR_MSG "Python UDF not allowed here"
...
#define OB_ERR_INVALID_PYTHON_UDF__ORA_USER_ERROR_MSG "Python UDF not allowed here"
