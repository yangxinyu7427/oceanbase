...
public:
  ...
  inline void set_ret(const enum ObPythonUDF::PyUdfType ret) { ret_ = ObPythonUDF::PyUdfType(ret); }
  ...
  inline enum ObPythonUDF::PyUdfType get_ret() const { return ret_; }
...
private:
  ...
  enum ObPythonUDF::PyUdfType ret_;
